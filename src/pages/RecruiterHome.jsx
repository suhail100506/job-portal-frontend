                                            ...
                                            <div className="flex-1">
                                                ...
                                                <div className="flex items-center gap-2 mb-1">
                                                    ...
                                                    {app.resume && (
                                                        <a
                                                            href={
                                                                `${import.meta.env.VITE_API_URL?.replace('/api', '') || 'http://localhost:5000'}/api/files/download/view/${encodeURIComponent(app.resumeFilename || `resume_${app.applicant?.name?.replace(/\s+/g, '_') || 'applicant'}.pdf`)}?url=${encodeURIComponent(app.resume)}&token=${localStorage.getItem('token')}`
                                                            }
                                                            target="_blank"
